"""Function-based views for lettings app"""
...
def lettings_index(request):
    """
    View for the page containing/rendering the lettings list.
...
def letting(request, letting_id):
    """
    View for the page containing/rendering the letting details.
    :param request: the user request
